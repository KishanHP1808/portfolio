...
export const ProjectsShowcase: React.FC<ProjectsShowcaseProps> = ({
  ...
  return (
    <section id="work" className="relative w-full py-24 md:py-36 px-6 md:px-12 lg:px-16 select-none">
      {/* Editorial Section Header */}
      <div className="max-w-[1700px] mx-auto mb-20 md:mb-28 border-b border-white/10 pb-8 flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          ...
          <h2 className="font-display text-5xl md:text-7xl lg:text-8xl text-white uppercase tracking-tighter">
            FEATURED WORK
          </h2>
        </div>
      ...
      <div className="max-w-[1700px] mx-auto space-y-32 md:space-y-48">
              ...
              >
                ...
                >
                  ...
                  <div className="overflow-hidden mb-4">
                    <h3
                      onClick={() => onSelectProject(project)}
                      className="font-display text-4xl md:text-6xl lg:text-7xl text-white uppercase tracking-tighter cursor-pointer hover:text-[#00f0ff] transition-colors duration-300"
                    >
                      {project.title}
                    </h3>
                  </div>
                  ...
                  <p className="font-serif-editorial italic text-xl md:text-2xl text-neutral-300 font-light mb-4">
                    {project.subtitle}
                  </p>
                  ...
                  {/* Metadata spec pills */}
                  <div className="grid grid-cols-2 gap-4 py-4 border-y border-white/10 mb-6 text-xs font-mono">
                    <div>
                  ...
                  <div className="flex flex-wrap gap-2 mb-8">
                    {project.technologies.slice(0, 5).map((tech) => (
                      <span
                        key={tech}
                        className="px-3 py-1 rounded-full border border-white/10 bg-white/[0.03] text-[11px] font-mono text-neutral-300"
                      >
                        {tech}
                      </span>
                    ))}
                  ...
                  <div className="flex flex-wrap items-center gap-3">
                    {project.liveUrl && (
                      <a
                        ...
                        onMouseLeave={onHoverEnd}
                        className="group/live inline-flex items-center gap-2.5 px-6 py-3 rounded-full bg-[#00f0ff] text-black hover:bg-white transition-all duration-300 font-condensed tracking-wider uppercase text-sm font-bold shadow-[0_0_25px_rgba(0,240,255,0.45)]"
                      >
                        <span>LAUNCH LIVE APP</span>
                        <ArrowUpRight className="w-4 h-4 transition-transform duration-300 group-hover/live:translate-x-1 group-hover/live:-translate-y-1" />
                      </a>
                    )}
                    ...
                    <button
                      ...
                      onMouseLeave={onHoverEnd}
                      className="group/btn inline-flex items-center gap-3 px-5 py-3 rounded-full border border-white/20 bg-white/5 hover:border-white hover:bg-white/10 transition-all duration-300 text-white font-condensed tracking-wider uppercase text-sm font-semibold cursor-pointer"
                    >
